...
1. **rc34 deployen + MacBook-Kit auf 3 Macs ausrollen:** Neue VOD Print Bridge ersetzt QZ Tray. Install auf Franks MacBook Air, Mac Studio, Robins MBP via `bash frank-macbook-setup/install.sh`. Entfernt altes QZ Tray automatisch. Bridge-Health via `curl -s http://127.0.0.1:17891/health`. Rollout-Doku: [`frank-macbook-setup/INSTALLATION.md`](frank-macbook-setup/INSTALLATION.md) + [`frank-macbook-setup/print-bridge/README.md`](frank-macbook-setup/print-bridge/README.md).
2. **Zweiter Frank-Test-Durchlauf (Inventur v2 nach rc33):** Asmus Tietchens wurde gestern getestet, heute zurückgesetzt — Frank kann das Item + weitere 5-10 Artikel nochmal durchgehen. Search ist 47× schneller (130ms statt 6s), VOD-19586 direkt suchbar, Discogs-Preise klarer (Markt vs Suggestion mit 3 Quick-Fill-Buttons), Label-Preis aktualisiert sich nach Direct-Price-Save + Save (Single-Exemplar-Mirror).

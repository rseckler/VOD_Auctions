...
**Last Updated:** 2026-05-11 — **rc54.0 Country-ISO Migration** live (48.694 Rows auf ISO-3166-1 alpha-2, CHECK-Constraint aktiv, 255 Meili-Synonyms). Volle Release-Historie + Details aller rc53.x/rc54.x-Releases: [`docs/architecture/CHANGELOG.md`](docs/architecture/CHANGELOG.md). Operative Arbeitsliste: [`docs/TODO.md`](docs/TODO.md).

...
const SyncDashboardPage = () => {
  ...
  // Batch Matching: COMPLETED 2026-03-07. All 30,171 music releases processed,
  // 16,590 matched (55%), 13,581 not on Discogs. Widget removed 2026-04-07.
  // API endpoint /admin/sync/batch-progress still exists for reference but
  // is no longer polled.
  ...
  // Extraartists Import: COMPLETED 2026-03-10. 16,590/16,590 releases processed,
  // 27,743 new artists, 46,470 links created. Widget removed 2026-04-07.
  // API endpoint /admin/sync/extraartists-progress still exists for reference.
  ...
  return (
    <PageShell>
      ...
      {/* Batch Matching: COMPLETED — widget removed 2026-04-07.
          All 30,171 music releases processed, 16,590 matched (55%).
          See docs/architecture/SYNC_SERVICES_OVERVIEW.md §2.3. */}
